# Subsaharan-Africa-Climate-Dynamics-Suite
...
1. **Sudano-Sahelian Thermal Maximums (Maiduguri City, Borno State):** Tracking extreme monthly maximum (`tmmx`) and minimum (`tmmn`) temperature variations in an arid Northern urban hub.
2. **Coastal Atlantic Precipitation Patterns (Lagos City, Lagos State):** Evaluating monthly cumulative rainfall dynamics (`pr`) in a tropical coastal megacity.
